...
class BatsmanThree {
	...
	public BatsmanThree(String name, int runsScored, int centuries,
...
public class COJ_01_03_Batsman {
	...
	public static void main(String[] args) {
		...
		BatsmanThree batsman1 = new BatsmanThree();
		...
		BatsmanThree batsman2 = new BatsmanThree("AB de Villers", 687, 1, 6, 407, 57, 37);
