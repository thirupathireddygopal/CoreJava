...
class Espncricinfo {
	...
	public Class<Batsman[]> getBatsMans() {
		return Batsman[].class;
	}
	


	public static int addBatsman(String name,int runsScored,int centuries,int ballsFaced,int fours,int sixes) {
		if(noOfBatsmen < (SIZE-1)) {
		//int varAdd = addBatsman(name, runsScored, centuries, ballsFaced, fours, sixes,noOfBatsmen);
			return 
		}
		else {
			return 0;
