...
class BatsmanSecond{
	...
	private String name;    //Attributes or Data Members
	...
	public BatsmanSecond() {
		super();
		
	}

	public BatsmanSecond(String name, int runsScored, int centuries, int halfCenturies, int ballsFaced, int fours,
			int sixes) {
		super();
		this.name = name;
...
public class COJ_01_02_Batsman {

	
	public static void main(String[] args) {
		
		
		BatsmanSecond batsman1 = new BatsmanSecond();
        ...
        BatsmanSecond batsman2 = new BatsmanSecond("AB de Villers", 687, 1, 6, 407, 57, 37);
